...
<p align="center">
  <img width="900" src="docs/preview-sleek.webp" alt="Sleek Phantom layout">
</p>

<p align="center">
  <img width="900" src="docs/preview-summon.webp" alt="Summoning Circle layout">
</p>
...
- 🖼️ **Visual login** — Players see a beautiful screen with their character portrait. One click and they're in.
- 🔑 **Password support** — Optionally require a password for specific players. The prompt appears right on the login screen.
- 👁️ **Show/hide players** — Choose which characters appear on the screen. Hide the GM, hide inactive players.
- 🎨 **8 layouts to choose from** — Pick the style that fits your game's mood (see below).
...
- 🏷️ **Custom title & favicon** — Set the browser tab title and icon so it looks like your own game portal.
...
| 🔮 **Summoning Circle** | 1:1 | Players as mystical orbs around a magic circle; each orb bears a unique arcane symbol in the player's color |
...
## ⚙️ Setup (GM only — takes about 2 minutes)
...
- [🖼️ Image Format Guide](https://github.com/brunocalado/custom-login/wiki/Image-Format-Guide)
